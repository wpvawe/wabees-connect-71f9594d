...
> **Ye file har naye task ke saath as a reference de do. Isme saari instructions, deployment steps, aur rules hain. Single source of truth — root `rules.md` yahan merge ho gayi hai.**
